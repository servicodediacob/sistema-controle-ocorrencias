    ...
    VitePWA({
      ...
      workbox: {
        ...
        runtimeCaching: [
          ...
          {
            urlPattern: ({ url }) => url.pathname.startsWith('/api/ocorrencias-detalhadas'),
            handler: 'StaleWhileRevalidate',
            options: {
          ...
          {
            urlPattern: ({ url }) => url.pathname.startsWith('/api/ocorrencias'),
            handler: 'StaleWhileRevalidate',
            options: {
          ...
          {
            urlPattern: ({ url }) => url.pathname.startsWith('/api/relatorio-completo'),
            handler: 'StaleWhileRevalidate',
            options: {
          ...
          {
            urlPattern: ({ url }) => url.pathname.startsWith('/api/obitos-registros'),
            handler: 'StaleWhileRevalidate',
            options: {
