-- Versão 10.1: Adiciona constraint de chave estrangeira em ocorrencia_destaque
...
CREATE TABLE ocorrencia_destaque (
    ...
    -- Garante que o destaque só pode apontar para uma ocorrência detalhada que existe.
    -- Se a ocorrência for deletada, o destaque é automaticamente zerado (SET NULL).
...
-- Removidas as tabelas 'ocorrencias' e 'obitos' que não estão mais em uso no fluxo principal.
